...
const DICT = {
  zh: {
    ...
    'log.collapse': '收起',
    'log.expand': '展开',
    'log.empty': '还没有处理记录，拖入图片后这里会实时显示执行过程。',
    'log.hint': '全部在浏览器内执行，照片不会离开本机。',
  ...
  en: {
    ...
    'log.expand': 'Expand',
    'log.empty': 'No activity yet — drop images and the pipeline shows up here live.',
    'log.hint': 'Runs entirely in your browser; photos never leave this device.',
